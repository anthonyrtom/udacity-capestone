...
def create_app(test_config=None):
    ...
    @app.route("/")
    def home():
        return "Life is sweat, with all its ups and downs.You may be going through a lot today but it will pass.When I look at my life, it sometimes looks like a lost cause but when I look deep, I realise I am still alive, I am health and I am able bodied. Isnt that amazing? I thank God for this life. The completion of this Capestone project gives me so much joy. By Antony"
